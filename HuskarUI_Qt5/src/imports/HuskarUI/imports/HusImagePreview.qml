        ...
        Item {
            ...
            states: [
                State {
                    ...
                    PropertyChanges { target: __imagePreview; opacity: 1.0 }
                    PropertyChanges { target: __imagePreview; scale: 1.0 }
                },
                State {
                    name: 'close'
                    when: !__private.visible
                    PropertyChanges { target: __imagePreview; opacity: 0.0 }
                    PropertyChanges { target: __imagePreview; scale: 0.0 }
                }
            ]
            transitions: [
                Transition {
